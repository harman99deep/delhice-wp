...
export default function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #FDF6FB 0%, #FDE8EF 70%, #F9E9F0 100%)' }}>
      ...
      {/* Order Form Section */}
      <section id="order" className="py-16 px-4" style={{ background: 'linear-gradient(135deg, #FFF6FA 0%, #FDE8EF 50%, #F9E9F0 100%)' }}>
        <div className="container mx-auto">
          <div className="text-center mb-12">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <a href="#home" className="block text-[#B86B6B] hover:text-white transition-colors">Home</a>
                <a href="#about" className="block text-[#B86B6B] hover:text-white transition-colors">About Us</a>
