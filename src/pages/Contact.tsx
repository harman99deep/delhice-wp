              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#B86B6B]">Delhi, India</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-[#B86B6B] space-y-1">
                      ...
                      <p>48h advance order required</p>
                    </div>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 space-y-6 border border-pink-100">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-[#F9E7EF] rounded-2xl p-4">
                    <h4 className="font-semibold text-[#B86B6B]">48h Fresh Guarantee</h4>
                    <p className="text-sm text-[#B86B6B]">Baked fresh within 48 hours of delivery</p>
                  </div>
                  <div className="bg-[#F9E7EF] rounded-2xl p-4">
