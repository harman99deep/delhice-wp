...
export default function Menu() {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #FDF6FB 0%, #FDE8EF 70%, #F9E9F0 100%)' }}>
      {/* Navigation */}
      <nav className="bg-[#FFF6FA]/90 backdrop-blur-md fixed w-full top-0 z-50 shadow-sm border-b border-pink-100">
      ...
      <section id="menu" className="py-16 px-4" style={{ background: 'linear-gradient(135deg, #FFF6FA 0%, #FDE8EF 50%, #F9E9F0 100%)' }}>
        <div className="container mx-auto">
          ...
          <Tabs defaultValue="bento-cakes" className="w-full">
            <TabsList className="w-full bg-white/80 backdrop-blur-sm rounded-xl p-3 mb-8 overflow-visible">
              <div className="grid grid-cols-2 lg:grid-cols-5 gap-2 w-full">
                {/* Row 1: Bento Cakes and Frosted Cakes */}
                <TabsTrigger 
                  value="bento-cakes" 
                  className="text-[#B86B6B] data-[state=active]:bg-[#B86B6B] data-[state=active]:text-white rounded-lg px-3 py-2 text-sm font-medium transition-all duration-200 hover:bg-pink-50"
                >
                  Bento Cakes
                </TabsTrigger>
                <TabsTrigger 
                ...
                <TabsTrigger 
                  ...
                  className="text-[#B86B6B] data-[state=active]:bg-[#B86B6B] data-[state=active]:text-white rounded-lg px-3 py-2 text-sm font-medium transition-all duration-200 hover:bg-pink-50 col-span-2 lg:col-span-1"
                >
                  Delhice Specials
                </TabsTrigger>
              </div>
          ...
          <div className="mt-12 text-center">
            <div className="bg-pink-100 p-6 rounded-2xl inline-block">
              <div className="space-y-2">
                <p className="text-[#B86B6B] font-medium">• Baked fresh. Order 48h in advance</p>
      ...
      {/* Footer */}
      <footer className="bg-[#FBCFE8] text-[#B86B6B] py-12 px-4">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <a href="#bento-cakes" className="block text-[#B86B6B] hover:text-white transition-colors">Bento Cakes</a>
                <a href="#frosted-cakes" className="block text-[#B86B6B] hover:text-white transition-colors">Frosted Cakes</a>
                <a href="#cupcakes" className="block text-[#B86B6B] hover:text-white transition-colors">Cupcakes</a>
